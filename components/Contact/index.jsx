            ...
            <div className="my-10 grid grid-cols-2 gap-0 lg:grid-cols-5 sm:grid-cols-3 sm:gap-4">
                ...
                <ul>
                    ...
                    <li className="mb-4 text-gray-300 text-md w-max" title="Twitter">
                        <a href="https://twitter.com/ByAylinMorales" className="flex gap-2 justify-start items-center w-max ease-in-out duration-150 hover:text-teal-500">
                            <FaTwitter />
                            <span className="text-sm font-initial">/ByAylinMorales</span>
                        </a>
                    </li>
                </ul>
                <div className="mt-10 sm:mt-0">
                    <h2 className="text-2xl text-teal-500 font-bold mb-2 sm:text-3xl">Start project?</h2>
                    <h3 className="text-md text-gray-400 sm:text-xl">aylinxmorales@gmail.com</h3>
                </div>
            </div>
        </div>
    );
